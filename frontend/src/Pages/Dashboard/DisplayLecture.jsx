...
const DisplayLectures = () => {
  ...
  const courseDetails = useLocation().state; //  will hold any state data that was passed along with the current URL location using React Router. 
  //This is commonly used for passing data between different components or pages in a React application.
